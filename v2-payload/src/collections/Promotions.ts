...
const Promotions: CollectionConfig = {
  ...
  fields: [
    ...
    // --- Discount ---
    {
      ...
      fields: [
        ...
        },
        {
          ...
          required: true,
          min: 0,
          admin: { width: '50%', step: 0.01, description: '% or fixed amount' },
        },
      ],
    },
    {
      name: 'currency',
      label: 'Currency (for Fixed Amount)',
      type: 'select',
    ...
    // --- Rules & Limits ---
    {
      ...
      type: 'number',
      min: 0,
      admin: { description: 'Optional: Max total uses. Blank for unlimited.' },
    },
    {
      type: 'row',
      fields: [
    ...
    },
    {
      ...
      type: 'number',
      min: 0,
      admin: { description: 'Optional: Order total must meet this amount.' },
    },
    // --- Applicability ---
    {
      name: 'appliesToAllEvents',
      label: 'Applies To All Events?',
      type: 'checkbox',
      defaultValue: true,
    },
    {
      ...
      hasMany: true,
      admin: {
        condition: (data) => !data.appliesToAllEvents,
        description: 'Only applies to these specific events if not checked above.',
      },
