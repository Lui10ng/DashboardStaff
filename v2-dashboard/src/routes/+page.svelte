				...
				>
					...
					>
						...
						<div class="space-y-6">
							<!-- Event Name -->
							<div class="space-y-2">
								<label for="title" class="prose block text-sm font-medium text-gray-700"
									>Event Name</label
								>
								<input
									type="text"
				...
				{:else}
					<div class="mb-5 flex items-center justify-between">
						...
						<div class="relative">
							...
							></i>
							<select
								class="rounded-lg border px-3 py-2 pl-10 pr-5 text-left text-sm text-gray-700"
							>
							...
							<div class="rounded-lg border border-gray-200 bg-white p-0 shadow-sm">
								<div class="p-3 sm:p-4">
									<div class="flex items-center justify-between pb-5">
										...
										>
											<i class="fa-solid fa-chart-line text-[8px] md:text-[13px] lg:text-[13px]"
											></i>
										</div>
									</div>
							...
							<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
								<div class="p-3 sm:p-4">
									<div class="flex items-center justify-between pb-5">
										...
										>
											<i class="fa-solid fa-user-group text-[8px] md:text-[13px] lg:text-[13px]"
											></i>
										</div>
									</div>
									<div
							...
							<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
								<div class="p-3 sm:p-4">
									<div class="flex items-center justify-between pb-5">
										...
										>
											<i class="fa-regular fa-calendar text-[8px] md:text-[13px] lg:text-[13px]"
											></i>
										</div>
									</div>
												...
												>
													...
													<LayerchartTooltip.Root let:data>
														<div class="rounded-[10px] bg-[#f1f1f1] p-3 text-black">
															...
															<div
																class="inline-flex items-center justify-between gap-5 text-[12px]"
															>
						...
						<Modal bind:open={isEditModalOpen}>
							...
							{#snippet content()}
								<div class="space-y-6 p-6">
									...
									>
										<div class="space-y-2">
											<label for="revenue-goal" class="text-sm font-medium text-gray-700"
												>Revenue Goal</label
											>
											<div class="relative">
										...
										<div class="space-y-2">
											<label for="attendees-goal" class="text-sm font-medium text-gray-700"
												>Attendees Goal</label
											>
											<input
												type="number"
