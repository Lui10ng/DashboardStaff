...
<div class="space-y-5" in:fly={{ y: -50, duration: 200 }}>
	...
	<Tabs.Root value="tab1">
		<Tabs.List>
			<Tabs.Trigger
				value="tab1"
				class="prose border-b-2 px-4 py-3 text-sm font-medium transition-colors focus:outline-none data-[state=active]:border-[#DF4D60] data-[state=active]:text-[#DF4D60] data-[state=inactive]:border-transparent data-[state=inactive]:text-gray-500 data-[state=inactive]:hover:border-gray-300 data-[state=inactive]:hover:text-gray-700"
			...
			>
				...
				>
					...
					<div class="space-y-6">
						<!-- Event Name -->
						<div class="space-y-2">
							<label for="event" class="prose block text-sm font-medium text-gray-700">Event Name</label>
							<input
								type="text"
						...
						<div class="mt-8 space-y-2">
							<label for="subdomain" class="prose block text-sm font-medium text-gray-700">Subdomain</label>
				...
				{/if}
						...
						<div class="mt-8 space-y-6">
							...
							<div class="space-y-2">
								<div class="flex items-center gap-2">
									...
									<label for="startDate" class="prose text-sm font-medium text-gray-700">Start</label>
								</div>
							...
							<div class="space-y-2">
								<div class="flex items-center gap-2">
									<label for="location" class="prose text-sm font-medium text-gray-700">Location</label>
								</div>
								<LocationMap
					...
					<div class="space-y-6">
						<div class="shadow-xs space-y-5 rounded-lg border border-gray-200 p-6">
							...
							<div class="space-y-2">
								<label for="background" class="prose mb-2 block text-sm font-medium text-gray-700">
									Background Image
								</label>
			...
			<div class="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
				...
				<div>
					{#each paginatedEvents as event (event.id)}
						<div
							class="grid grid-cols-2 sm:grid-cols-12 items-center cursor-pointer justify-between gap-2 border-b border-gray-200 p-4 transition-colors hover:bg-gray-50"
						...
						>
							<div class="col-span-3 sm:row-span-3 overflow-hidden rounded-lg">
								<img
							...
							<div class="col-span-3">
								<p class="prose text-start mb-1 text-sm  text-font-primary">Date</p>
								<div class="flex flex-col gap-1">
									<div class="flex items-center gap-2">
										<i class="fa-regular fa-calendar text-gray-400"></i>
										<span class="prose text-gray-600 text-sm">
							...
							<div class="col-span-1 sm:col-span-3">
								<p class="prose text-sm  sm:text-start text-font-primary mb-1">Status</p>
								<h3 class="prose inline-block px-5 py-1 text-sm rounded-full {formatStatus(event.status)}">
									{event.status}
								</h3>
							</div>
							<div class="sm:col-span-3">
								<p class="prose text-sm text-font-primary mb-1">Ticket Sold</p>
				...
				<div class="inline-block min-w-full align-middle">
					<table class="min-w-full divide-y divide-gray-200">
						...
						<thead class="bg-secondary">
							<tr>
								<th class="prose px-4 py-3 text-left text-sm font-medium whitespace-nowrap text-black"
									>No.</th
								>
								<th class="prose px-4 py-3 text-left text-sm font-medium whitespace-nowrap text-black"
									>Event Name</th
						...
						<tbody class="divide-y divide-gray-200 bg-white">
							{#each paginatedEvents as event, index}
								<tr class="hover:bg-gray-50">
									<td class="prose px-4 py-3 text-sm whitespace-nowrap text-gray-900">{index + 1}</td>
									<td class="prose px-4 py-3 text-sm whitespace-nowrap text-gray-900">{event.title}</td>
									<td class="prose px-4 py-3 text-sm whitespace-nowrap text-gray-900"
									...
									>
									<td class="prose px-4 py-3 whitespace-nowrap">
										<span
