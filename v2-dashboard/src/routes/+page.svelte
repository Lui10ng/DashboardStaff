...
<div class="space-y-6">
	...
	<div class="space-y-2">
		...
		<input
			...
			name="event"
			class="w-full rounded-xl border border-gray-200 px-4 py-4 text-[16px] text-gray-500 placeholder-gray-500 transition-colors outline-none"
		/>
		{#if $errors.event}
	...
	<div class="mt-8 space-y-2">
		...
		<div class="flex items-center overflow-hidden rounded-xl border border-gray-200">
			...
			<input
				...
				class="flex-1 px-2 py-4 text-[16px] text-gray-500 transition-colors outline-none"
			/>
