    ...
    <div class="">
        ...
        <div>
          ...
          <div class="mt-1 flex items-center rounded-md bg-[#F7F8FA] px-3 py-2 group focus-within:bg-[#e9ecf3]">
            ...
            <i class="fa-solid fa-globe h-4 w-4 "></i>
                  ...
                  <div>
                    ...
                    <div class="relative mt-1">
                      <span class="absolute inset-y-0 left-3 flex items-center ">
                        <i class="fa-solid fa-location-dot h-4 w-4"></i>
                      </span>
                      <input
                        Name="Event Address"
                        type="text"
                ...
                <div class="space-y-4 md:col-span-1 lg:col-span-1">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <i class="fa-regular fa-envelope absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 "></i>
                    </div>
                  </div>
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <i class="fa-regular fa-phone absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5"></i>
                    </div>
                  </div>
                </div>
