...
<div class="space-y-8">
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
		<Card  icon="fa-solid fa-dollar-sign text-green" iconText="Wallet Balance" content="₱32,550.00">
			<Modal buttonText="Wallet Balance" buttonClass="text-green text-sm cursor-pointer">
				{#snippet header()}
		...
		<Card  icon="fa-solid fa-dollar-sign text-green" iconText="Gross Income" content="₱92,550.00">
			<Modal buttonText="Gross Income" buttonClass="text-green text-sm cursor-pointer">
				{#snippet header()}
	...
	<div class="rounded-xl border border-gray-200 shadow-sm sm:p-6">
		...
		<div class="space-y-4">
			{#each walletTransactions as transaction (transaction.id)}
				<div
					class="flex flex-col justify-between gap-4 rounded-lg bg-gray-50 p-4 hover:bg-gray-100 sm:flex-row sm:items-center"
				>
