...
export async function load({ locals }) {
  ...
  const lowerBoxAvailable = isTicketInTimeWindow('2025-04-10T10:00:00', '2025-04-17T23:59:59');
  const upperBoxAvailable = isTicketInTimeWindow('2025-04-17T10:00:00', '2025-04-17T23:59:59');
  

  const lowerBoxAvailableIn = getTimeUntilAvailable('2025-04-10T10:00:00');
  const upperBoxAvailableIn = getTimeUntilAvailable('2025-04-17T10:00:00');
  ...
  const ticketTypes = [
    ...
    { id: 'lowerBox', name: 'LOWER BOX', price: 1000, available: lowerBoxAvailable, availableFrom: '2025-04-10T10:00:00', availableUntil: '2025-04-17T23:59:59', availableIn: lowerBoxAvailableIn, remainingTickets: 150, totalTickets: 150, color: 'bg-pink-600', textColor: 'text-pink-500' },
    { id: 'upperBox', name: 'UPPER BOX', price: 700, available: upperBoxAvailable, availableFrom: '2025-04-17T10:00:00', availableUntil: '2025-04-17T23:59:59', availableIn: upperBoxAvailableIn, remainingTickets: 200, totalTickets: 200, color: 'bg-teal-500', textColor: 'text-teal-500' },
