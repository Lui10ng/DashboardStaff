export const load = async () => {
	return {
		headerInfo: {
			title: 'Get in touch',
			description: 'Our Veent team would love to hear from you.'
		},
		contactDetails: [
			{
				...
				title: 'Email',
				description: 'Veent team is here to help.',
				info: 'hello@veent.io'
			},
			{
				...
				info: '2nd Floor, Lifestyle District,<br />Corrales Ext., Cagayan de Oro City 9000'
			},
			{
