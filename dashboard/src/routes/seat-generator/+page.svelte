...
<div class="mx-auto max-w-7xl p-6 mt-20">
	...
	<div class="mb-8 border-b border-gray-200">
		<div class="flex space-x-4">
			<button
				class="py-3 px-4 text-sm font-medium border-b-2 transition-colors focus:outline-none"
		...
		<div class="flex flex-col space-y-6 max-w-3xl mx-auto">
			...
			<div class="space-y-2">
				...
				<div class="flex flex-col space-y-4">
					...
					<div class="flex space-x-4">
						<button 
							class="h-12 w-12 rounded-full bg-blue-500 shadow-md hover:ring-2 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-300"
						...
						></button>
						<button 
							class="h-12 w-12 rounded-full bg-yellow-400 shadow-md hover:ring-2 hover:ring-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-300"
						...
						></button>
						<button 
							class="h-12 w-12 rounded-full bg-green-500 shadow-md hover:ring-2 hover:ring-green-300 focus:outline-none focus:ring-2 focus:ring-green-300"
						...
						></button>
						<button 
							class="h-12 w-12 rounded-full bg-olive-500 shadow-md hover:ring-2 hover:ring-olive-300 focus:outline-none focus:ring-2 focus:ring-olive-300"
						...
						></button>
						<button 
							class="h-12 w-12 rounded-full bg-red-400 shadow-md hover:ring-2 hover:ring-red-300 focus:outline-none focus:ring-2 focus:ring-red-300"
						...
						></button>
						<button 
							class="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md hover:ring-2 hover:ring-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300"
			...
			<div class="flex space-x-4 pt-6">
				<button
					class="flex-1 rounded bg-[#DF4D60] py-3 text-white hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-red-300"
					on:click={handleSaveTickets}
				>
					Save Tickets
				</button>
				<button
					class="flex-1 rounded border border-gray-300 py-3 text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300"
				>
					Cancel
				</button>
			</div>
					...
					{:else}
						...
						>
							<div class="mb-3 text-center">
								...
								<p class="mt-1 text-sm text-gray-600">Upload an image of your venue floor plan</p>
							...
							<label 
								...
								tabindex="0"
								on:keydown={(e) => e.key === 'Enter' && document.getElementById('venue-image-upload')?.click()}
							>
								Upload a file
							</label>
							<input 
				...
				<div class="relative h-[600px] overflow-hidden rounded ">
					<div class="absolute inset-0 overflow-auto bg-gray-100 p-8">
						...
						<div class="mb-6 text-center text-sm text-gray-500">
							(Rows: {section.seatConfig.rows} x Seats per Row: {section.seatConfig.seatsPerRow},
							Maximum allowed Seats: {ticketQuantity})
						</div>
											...
											{#each section.seats as row, rowIndex}
												<tr class="h-10">
													{#if section.seatConfig.rowLabel === 'Left Side' || section.seatConfig.rowLabel === 'Show All'}
														<td class="sticky left-0 z-10 w-10 bg-white pr-2 text-right font-medium">
															{generateRowLabel(
													...
													{#if section.seatConfig.rowLabel === 'Right Side' || section.seatConfig.rowLabel === 'Show All'}
														<td class="sticky right-0 z-10 w-10 bg-white pl-2 text-left font-medium">
															{generateRowLabel(
																section.seatConfig.rowStartChar,
																section.seatConfig.rowOrder === 'down'
																	? rowIndex
